...
- **Discover:** Read [catalog.json](https://bera-ui.vercel.app/transitions/manifest.json), inspect the relevant host interface, and identify the closest recipe by use case.
